# React useContext + useMemo + useState Demo

This is a simple React project demonstrating how to combine **useContext**, **useState**, and **useMemo** hooks to manage global state efficiently and optimize performance.
